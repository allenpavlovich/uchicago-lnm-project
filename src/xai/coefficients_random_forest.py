...
def load_model_and_vectorizer(model_path, vectorizer_path):
    """Load the trained model and Bow vectorizer."""
...
def plot_top_coefficients(model, vectorizer):
    ...
    plt.title('Top 5 Positive and Negative Coefficients in Random Forest')
    plt.xlabel('Coefficient')
    plt.ylabel('Feature')
    plt.savefig('../../reports/figures/xai/rand_forst/rand_forst_top_coefficients.png')
    plt.show()
